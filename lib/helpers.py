...
def add_teacher(first_name, last_name, subject):
    session = Session()
    new_teacher = Teachers(first_name=first_name, last_name=last_name, subject = subject)
...
def add_grade(teacher_id, student_id, grade):
    ...
    new_grade = Grades(teachers_id=teacher_id, students_id=student_id, grade=grade)
